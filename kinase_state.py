...
Last edited on Wed Feb 11, 2026 by JG
@author: vivekmodi
"""
...
#            introstring= (f'{kinase:14} '
            ...
            string =string +  (
                ...
                f"{conf_df.at[index, 'APE_label']:<8} " #long space-separated string for each APE criteria
                ...
                f'{conf_df.at[index, "APE8_string"]:<9} '
                f'{conf_df.at[index, "APE9_string"]:<9} '
                f'{conf_df.at[index, "APE10_string"]:<9} '
                f'{conf_df.at[index, "APE11_string"]:<9} '
                f'{conf_df.at[index, "APE12_string"]:<9} '
                ...
                f'{conf_df.at[index, "DFG4_string"]:<9} '
                ...
                f'{conf_df.at[index, "HRDAsp_string"]:<9} '
                f'{conf_df.at[index, "aFasp_string"]:<9}\n'
                ...
                f'APE3_aFasp3 {conf_df.at[index, "APE3-aFasp3-dis"]:>6.2f} '
                f'APE10_DFG4 {conf_df.at[index, "APE10-DFG4-dis"]:>6.2f} '
                f'APE11_DFG4 {conf_df.at[index, "APE11-DFG4-dis"]:>6.2f} '
                f'APE12_DFG4 {conf_df.at[index, "APE12-DFG4-dis"]:>6.2f} '
