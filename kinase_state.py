...
Edited on Fri June 7, 2024 by RLD
    ...
    for model in structure:
        for chain in model:
            ...
            for item in ('Lys_restype', 'Glu4_restype', 'Glu_restype', 'XDFG_restype',   'Phe_restype',  'Gly_restype',
                         'Asp_restype', 'XHRD_restype', 'HRD_restype', 'HRDAsp_restype', 'DFG6_restype', 'HPN7_restype',
                         'APE_restype', 'APEp2_restype', 'APEp3_restype',
                         'aFasp_restype', 'aFasp3_restype', 'DFG4_restype'):
            ...
            for resname in ("XDFG","Lys","Glu","Glu4","Asp","Phe","Gly","HRD","XHRD","Arg","HRDAsp", "HRD7", "HRD8", "DFG4", "DFG6", "APE", "APE3", "APE6", "APE7", "APE8", "APE9", "APE10", "APE11", "APE12","APEp2","APEp3","HPN7","aFasp","GRL8","Hinge1"):
...
#            introstring= (f'{kinase:14} '
            ...
            string =string +  (
                ...
                f'{conf_df.at[index, "HRD_label"]} '
                f'{conf_df.at[index, "Spine_label"]:<10}\n'

                f'{introstring}'
                f'{"APEdihe_Labels":16} '
                f"{conf_df.at[index, 'APEdihe_label']:<8}\n" #long space-separated string for each APE criteria

                f'{introstring}'
                f'{"APEdist_Labels":16} '
                f"{conf_df.at[index, 'APEdist_label']:<8}\n" #long space-separated string for each APE criteria
                ...
                f'{introstring}'
                f'{"CTdom_Residues":16} '
                f'{conf_df.at[index, "XHRD_string"]:<12} '
                f'{conf_df.at[index, "HRD_string"]:<12} '
                f'{conf_df.at[index, "Arg_string"]:<12} '
                f'{conf_df.at[index, "HRDAsp_string"]:<12} '
                f'{conf_df.at[index, "HRD7_string"]:<12} '
                f'{conf_df.at[index, "HRD8_string"]:<12} '
                f'{conf_df.at[index, "aFasp_string"]:<11}\n'

                f'{introstring}'
                f'{"DFG_Residues":16} '
                f'{conf_df.at[index, "XDFG_string"]:<12} '
                f'{conf_df.at[index, "Asp_string"]:<12} '
                f'{conf_df.at[index, "Phe_string"]:<12} '
                f'{conf_df.at[index, "Gly_string"]:<12} '
                f'{conf_df.at[index, "DFG4_string"]:<11} '
                f'{conf_df.at[index, "DFG6_string"]:<10}\n'

                f'{introstring}'
                f'{"APE_Residues":16} '
                f'{conf_df.at[index, "APE_string"]:<12} '
                f'{conf_df.at[index, "APE6_string"]:<12} '
                f'{conf_df.at[index, "APE7_string"]:<12} '
                f'{conf_df.at[index, "APE8_string"]:<12} '
                f'{conf_df.at[index, "APE9_string"]:<11} '
                f'{conf_df.at[index, "APE10_string"]:<10} '
                f'{conf_df.at[index, "APE11_string"]:<10} '
                f'{conf_df.at[index, "APE12_string"]:<10}\n'

                f'{introstring}'
                f'{"HRD_bbDihedrals":16} '
                f'{"HRDHis":8} {conf_df.at[index, "HRD_Phi"]:>7.2f} '
                f'{conf_df.at[index, "HRD_Psi"]:>7.2f} '
                f'{"HRDArg":6} {conf_df.at[index, "Arg_Phi"]:>7.2f} '
                f'{conf_df.at[index, "Arg_Psi"]:>7.2f}\n'

                f'{introstring}'
                f'{"XDFG_bbDihedrals":16} '
                f'{"XDFG":8} {conf_df.at[index, "XDFG_Phi"]:>7.2f} '
                f'{conf_df.at[index, "XDFG_Psi"]:>7.2f} '
                f'{"DFGAsp":6} {conf_df.at[index, "Asp_Phi"]:>7.2f} '
                f'{conf_df.at[index, "Asp_Psi"]:>7.2f} '
                f'{"DFGPhe":6} {conf_df.at[index, "Phe_Phi"]:>7.2f} '
                f'{conf_df.at[index, "Phe_Psi"]:>7.2f} '
                f'{"DFGGly":6} {conf_df.at[index, "Gly_Phi"]:>7.2f} '
                f'{conf_df.at[index, "Gly_Psi"]:>7.2f}\n'              

                f'{introstring}'
                f'{"APE_bbDihedrals":16} '
                f'{"APE6":8} {conf_df.at[index, "APE6_Phi"]:>7.2f} '
                f'{conf_df.at[index, "APE6_Psi"]:>7.2f} '
                f'{"APE7":6} {conf_df.at[index, "APE7_Phi"]:>7.2f} '
                f'{conf_df.at[index, "APE7_Psi"]:>7.2f} '
                f'{"APE8":6} {conf_df.at[index, "APE8_Phi"]:>7.2f} '
                f'{conf_df.at[index, "APE8_Psi"]:>7.2f} '
                f'{"APE9":6} {conf_df.at[index, "APE9_Phi"]:>7.2f} '
                f'{conf_df.at[index, "APE9_Psi"]:>7.2f} '
                f'{"APE10":6} {conf_df.at[index, "APE10_Phi"]:>7.2f} '
                f'{conf_df.at[index, "APE10_Psi"]:>7.2f}\n'

                f'{introstring}'
                f'{"scDihedrals":16} '
                f'{"DFGAsp":8} {conf_df.at[index, "Asp_Chi1"]:>7.2f} '
                f'{conf_df.at[index, "Asp_Chi2"]:>7.2f} '
                f'{"DFGPhe":6} {conf_df.at[index, "Phe_Chi1"]:>7.2f} '
                f'{conf_df.at[index, "Phe_Chi2"]:>7.2f} '
                f'{"APE8":6} {conf_df.at[index, "APE8_Chi1"]:>7.2f}\n'

                f'{introstring}'
                f'{"APE_Distances":16} '
                f'{"APE9_Arg":8} {conf_df.at[index, "APE9-Arg-dis"]:>6.2f} '
                f'{"APE10_DFG4":10} {conf_df.at[index, "APE10-DFG4-dis"]:>6.2f} '
                f'{"APE11_DFG4":10} {conf_df.at[index, "APE11-DFG4-dis"]:>6.2f} '
                f'{"APE12_DFG4":10} {conf_df.at[index, "APE12-DFG4-dis"]:>6.2f}\n'

                f'{introstring}'
                f'{"Spine_Distances":16} '
                f'{"Spine1":8} {conf_df.at[index, "Spine1-dis"]:>6.2f} '
                f'{"Spine2":10} {conf_df.at[index, "Spine2-dis"]:>6.2f} '
                f'{"Spine3":10} {conf_df.at[index, "Spine3-dis"]:>6.2f} '
                f'{"MaxSpine":10} {conf_df.at[index, "Spine-dis"]:>6.2f}\n'

                f'{introstring}'
                f'{"Other_Distances":16} '
                f'{"Glu4_Phe":8} {conf_df.at[index, "Glu4-Phe-dis"]:>6.2f} '
                f'{"Lys_Phe":10} {conf_df.at[index, "Lys-Phe-dis"]:>6.2f} '
                f'{"Lys_Glu":10} {conf_df.at[index, "Lys-Glu-dis"]:>6.2f} '
                f'{"SaltBr":10} {conf_df.at[index, "LysNZ-GluOE-dis"]:>6.2f} '
            ...
            if conf_df.at[index,'Autoinhibit'] != '':
                string = string + (
                    f'{introstring}'
                    f'{"Autoinhibit":16} '
                    f'{conf_df.at[index,"Autoinhibit"]}\n')
