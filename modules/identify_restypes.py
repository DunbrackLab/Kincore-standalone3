        ...
        for chain in model:
            if int(model.id)==int(conf_df.at[index,'Model_id']) and str(chain.id)==str(conf_df.at[index,'Chain_id']):
                for residue in chain:
                    ...
                    if int(residue.id[1])==int(conf_df.at[index,'APE3_num']):
                        conf_df.at[index, 'APE3_restype']=seq1(residue.resname)
                    if int(residue.id[1])==int(conf_df.at[index,'APE8_num']):
                        conf_df.at[index, 'APE8_restype']=seq1(residue.resname)
                    if int(residue.id[1])==int(conf_df.at[index,'APE9_num']):
                        conf_df.at[index, 'APE9_restype']=seq1(residue.resname)
                    if int(residue.id[1])==int(conf_df.at[index,'APE10_num']):
                        conf_df.at[index, 'APE10_restype']=seq1(residue.resname)
                    if int(residue.id[1])==int(conf_df.at[index,'APE11_num']):
                        conf_df.at[index, 'APE11_restype']=seq1(residue.resname)
                    if int(residue.id[1])==int(conf_df.at[index,'APE12_num']):
                        conf_df.at[index, 'APE12_restype']=seq1(residue.resname)
                    if int(residue.id[1])==int(conf_df.at[index,'aFasp_num']):
                        conf_df.at[index, 'aFasp_restype']=seq1(residue.resname)
                    if int(residue.id[1])==int(conf_df.at[index,'aFasp3_num']):
                        conf_df.at[index, 'aFasp3_restype']=seq1(residue.resname)
                    ...
                    if int(residue.id[1])==conf_df.at[index,'HRDAsp_num'] :
                        conf_df.at[index,'HRDAsp_restype']=seq1(residue.resname)
                    if int(residue.id[1])==conf_df.at[index,'XHRD_num'] :
                        conf_df.at[index,'XHRD_restype']=seq1(residue.resname)
                    if int(residue.id[1])==conf_df.at[index,'DFG4_num'] :
                        conf_df.at[index,'DFG4_restype']=seq1(residue.resname)
                    if int(residue.id[1])==conf_df.at[index,'DFG5_num'] :
                        conf_df.at[index,'DFG5_restype']=seq1(residue.resname)
